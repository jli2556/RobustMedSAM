...
from robust_med_segment_anything import SamPredictor, sam_model_registry
from robust_med_segment_anything import SamAutomaticMaskGenerator, sam_model_registry
from robust_med_segment_anything.utils.transforms import ResizeLongestSide 
...
parser.add_argument("--model_size", type=str, default="b", help='size of ViT model in RobustMedSAM architecture (paper uses vit_b)')
